...
class TestExportUnknownCharactersCSV:
    ...
    def test_export_unknown_characters_csv_success(self, temp_dir, sample_unknown_chars):
        """
        Тест, который проверяет успешный экспорт 
        неизвестных символов в CSV файл
        """
        file_path = export_unknown_characters_csv(
            unknown_chars=sample_unknown_chars,
    ...
    def test_export_unknown_characters_csv_empty(self, temp_dir):
        """
    ...
    def test_export_unknown_characters_csv_special_chars(self, temp_dir, sample_unknown_chars_special):
        """
        Тест, который проверяет экспорт специальных 
        символов
        """
        file_path = export_unknown_characters_csv(
            unknown_chars=sample_unknown_chars_special,
