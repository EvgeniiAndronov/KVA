...
class TestGetAnalysisStatistics:
    ...
    def test_get_statistics_with_data(self, mock_db_connection, expected_statistics):
        """
    ...
    def test_get_statistics_no_data(self, mock_db_connection):
        """
    ...
    def test_get_statistics_empty_result(self, mock_db_connection):
        """
    ...
    def test_get_statistics_special_layout_name(self, mock_db_connection):
        """
    ...
    def test_get_statistics_null_values(self, mock_db_connection):
        """
        Тест, который проверяет обработку 
        NULL-значений из БД
        """
