...
class TestGetWordsFromFileStream(unittest.TestCase):
    ...
    def setUp(self):
        """
        Создает большой файл со словами для 
        тестирования потокового чтения
        """
    ...
    def test_stream_batch_processing(self):
        """
        Тест, который проверяет пакетную 
        обработку слов с размером батча по 
        умолчанию
        """
    ...
    def test_stream_file_not_found(self):
        ...
        ошибки отсутствия файла при потоковом 
        чтении
        """
        from scan_module.read_files import get_words_from_file_stream
    ...
    def test_stream_custom_batch_size(self):
        ...
        пользовательским размером батча
        """
        from scan_module.read_files import get_words_from_file_stream
